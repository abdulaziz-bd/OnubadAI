...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-[18px] w-[18px] translate-x-[3px] rounded-full bg-muted-faint shadow-sm ring-0 transition-transform data-[state=checked]:translate-x-[19px] data-[state=checked]:bg-white"
      )}
    />
  </SwitchPrimitives.Root>
))
